...
namespace TNPLCommerce.Infrastructure.Data.SqlHandlers
{
    public partial class SQLHandler
    {
        ...
        public DataSet ExecuteAsDataSet(string StroredProcedureName, IList<SQLParam> ParaMeterCollection)
        {
            SqlConnection SQLConn = new SqlConnection(this._connectionString);
            try
            {
        ...
        /// <param name="ParaMeterCollection">Accept key value collection for parameters.</param>
        /// <returns>Object of SqlDataReader.</returns>
        public SqlDataReader ExecuteAsDataReader(string StroredProcedureName, IList<SQLParam> ParaMeterCollection)
        {
            try
            {
                SqlConnection SQLConn = new SqlConnection(this._connectionString);
        ...
        /// <param name="ParaMeterCollection">Accept key value collection for parameters.</param>
        /// <returns></returns>
        public T ExecuteAsObject<T>(string StroredProcedureName, IList<SQLParam> ParaMeterCollection)
        {
            SqlConnection SQLConn = new SqlConnection(this._connectionString);
            try
            {
        ...
        public List<T> ExecuteAsList<T>(string StroredProcedureName, IList<SQLParam> ParaMeterCollection)
        {
            SqlConnection SQLConn = new SqlConnection(this._connectionString);
            try
            {
        ...
        /// <param name="ParaMeterCollection">Accept key value collection for parameters.</param>
        /// <returns>Type of the object implementing</returns>
        public T ExecuteAsScalar<T>(string StroredProcedureName, IList<SQLParam> ParaMeterCollection)
        {
            SqlConnection SQLConn = new SqlConnection(this._connectionString);
            try
            {
        ...
        public IList<SQLParam> BuildParameterCollection(IList<SQLParam> paramCollection, object obj, bool excludeNullValue)
        {
            try
            {
                if (excludeNullValue)
